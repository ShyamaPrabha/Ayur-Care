...
Future<Uint8List> generateInvoicePdf({
  ...
  final font = pw.Font.ttf(
    await rootBundle.load('assets/fonts/Poppins300.ttf'),
  );
          ...
          children: [
            pw.Positioned.fill(
              child: pw.Center(
                child: pw.Opacity(
                  opacity: 0.1,
                  child: pw.SvgImage(svg: imageBytes, width: 300, height: 300),
                ),
              ),
            ),
            pw.Column(
                  ...
                  children: [
                    ...
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(
                          "Cheepunkal PO, Kumarakom, Kerala - 686563",
...
pw.TableRow _buildRow(
  ...
  return pw.TableRow(
    children: [
      ...
      pw.Padding(
        padding: const pw.EdgeInsets.all(5),
        child: pw.Text(price, style: pw.TextStyle(font: font)),
      ),
      pw.Padding(
        padding: const pw.EdgeInsets.all(5),
        child: pw.Text(male, style: pw.TextStyle(font: font)),
      ),
      pw.Padding(
        padding: const pw.EdgeInsets.all(5),
        child: pw.Text(female, style: pw.TextStyle(font: font)),
      ),
      pw.Padding(
        padding: const pw.EdgeInsets.all(5),
